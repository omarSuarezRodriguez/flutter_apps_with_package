...
class RainbowCircularSliderExample extends StatelessWidget {
  const RainbowCircularSliderExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Rainbow Circular Slider Example')),
      body: const Center(
        child: HomeScreen(),
      ),
    );
